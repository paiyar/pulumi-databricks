...
namespace Pulumi.Databricks
{
    ...
    public sealed class ProviderArgs : Pulumi.ResourceArgs
    {
        ...
        public ProviderArgs()
        {
            AccountId = Utilities.GetEnv("DATABRICKS_ACCOUNT_ID");
            ConfigFile = Utilities.GetEnv("DATABRICKS_CONFIG_FILE");
            DebugHeaders = Utilities.GetEnvBoolean("DATABRICKS_DEBUG_HEADERS");
            DebugTruncateBytes = Utilities.GetEnvInt32("DATABRICKS_DEBUG_TRUNCATE_BYTES");
            Host = Utilities.GetEnv("DATABRICKS_HOST");
            Password = Utilities.GetEnv("DATABRICKS_PASSWORD");
            Profile = Utilities.GetEnv("DATABRICKS_PROFILE");
            RateLimit = Utilities.GetEnvInt32("DATABRICKS_RATE_LIMIT");
            Token = Utilities.GetEnv("DATABRICKS_TOKEN");
            Username = Utilities.GetEnv("DATABRICKS_USERNAME");
        }
    }
}
