...
namespace Pulumi.Databricks
{
    public static class GetServicePrincipal
    {
        ...
        ///             DisplayName = "admins",
        ///         }));
        ///         var spn = Output.Create(Databricks.GetServicePrincipal.InvokeAsync(new Databricks.GetServicePrincipalArgs
        ///         {
        ///             ApplicationId = "11111111-2222-3333-4444-555666777888",
        ///         }));
        ///         var myMemberA = new Databricks.GroupMember("myMemberA", new Databricks.GroupMemberArgs
        ///         {
        ///             GroupId = admins.Apply(admins =&gt; admins.Id),
        ///             MemberId = spn.Apply(spn =&gt; spn.Id),
        ///         });
        ///     }
        /// 
        /// }
