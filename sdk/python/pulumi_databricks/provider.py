...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        if account_id is None:
            account_id = _utilities.get_env('DATABRICKS_ACCOUNT_ID')
        ...
        if config_file is None:
            config_file = _utilities.get_env('DATABRICKS_CONFIG_FILE')
        if config_file is not None:
            pulumi.set(__self__, "config_file", config_file)
        if debug_headers is None:
            debug_headers = _utilities.get_env_bool('DATABRICKS_DEBUG_HEADERS')
        ...
        if password is None:
            password = _utilities.get_env('DATABRICKS_PASSWORD')
        if password is not None:
            pulumi.set(__self__, "password", password)
        if profile is None:
            profile = _utilities.get_env('DATABRICKS_PROFILE')
        if profile is not None:
            pulumi.set(__self__, "profile", profile)
        if rate_limit is None:
            rate_limit = _utilities.get_env_int('DATABRICKS_RATE_LIMIT')
        if rate_limit is not None:
            pulumi.set(__self__, "rate_limit", rate_limit)
        if skip_verify is not None:
            pulumi.set(__self__, "skip_verify", skip_verify)
        if token is None:
            token = _utilities.get_env('DATABRICKS_TOKEN')
        if token is not None:
            pulumi.set(__self__, "token", token)
        if username is None:
            username = _utilities.get_env('DATABRICKS_USERNAME')
