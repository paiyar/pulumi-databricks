module github.com/paiyar/pulumi-databricks/provider
...
require (
	github.com/databricks/terraform-provider-databricks v1.2.0
...
require (
	...
	github.com/pulumi/pulumi/pkg/v3 v3.25.1 // indirect
